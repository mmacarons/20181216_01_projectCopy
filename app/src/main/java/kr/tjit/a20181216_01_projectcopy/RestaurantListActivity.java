...
//        ();여기까지 치고 alt + enter
    ...
    private void fillRestaurants() {
        ...
        restaurants.add(new Restaurant("미스터피자", "관악구", "08:00 ~ 21:00"));
        restaurants.add(new Restaurant("피자헛", "강동구", "07:00 ~ 20:00"));
        restaurants.add(new Restaurant("파파존스", "성북구", "06:00 ~ 23:00"));
